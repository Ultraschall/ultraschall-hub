...
UltHub_Device::UltHub_Device(AudioObjectID inObjectID)
        :
        ...
        mVolumeCurve() {
            ...
            mStreamDescription.mChannelsPerFrame = 2;
        ...
        case kAudioObjectPropertyOwnedObjects:
            switch(inAddress.mScope)
            {
                ...
                case kAudioObjectPropertyScopeOutput:
                    ...
                    break;
                case kAudioObjectPropertyScopePlayThrough:break;
                case kAudioObjectPropertyScopeWildcard:break;
            };
            break;
...
void	UltHub_Device::Device_SetPropertyData(AudioObjectID inObjectID, pid_t inClientPID, const AudioObjectPropertyAddress& inAddress, UInt32 inQualifierDataSize, const void* inQualifierData, UInt32 inDataSize, const void* inData)
{
    ...
    switch(inAddress.mSelector)
    {
        ...
        default:
            ...
            break;
        case kAudioObjectPropertySelectorWildcard:break;
    };
}
