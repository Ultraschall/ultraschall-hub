//
//  UltraschallHubXPCServiceProtocol.h
...
@protocol UltraschallHubXPCServiceProtocol
...
/*
 To use the service from an application or other process, use NSXPCConnection to establish a connection to the service by doing something like this:
     ...
     _connectionToService = [[NSXPCConnection alloc] initWithServiceName:@"fm.ultraschall.UltraschallHubXPCService"];
